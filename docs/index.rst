...
========================================
Zeek Package Documentation: opcua Protocol Analyzer
========================================
...
If the plugin is explicitly loaded (:code:`@load Demo/opcua_analyzer`), the load process continues:

5. :doc:`Demo/opcua_analyzer/__load__.zeek </scripts/Demo/opcua_analyzer/__load__.zeek>` then loads the rest of the scripts.
